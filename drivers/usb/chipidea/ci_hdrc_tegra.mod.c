...
MODULE_ALIAS("of:N*T*Cnvidia,tegra20-ehci");
MODULE_ALIAS("of:N*T*Cnvidia,tegra20-ehciC*");
MODULE_ALIAS("of:N*T*Cnvidia,tegra30-ehci");
MODULE_ALIAS("of:N*T*Cnvidia,tegra30-ehciC*");
